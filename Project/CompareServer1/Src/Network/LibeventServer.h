...
namespace Network
{
    typedef void(*pCallbackHandleReading)(evutil_socket_t fd, const std::string& strData, void* pUser);
    ...
    public:
        ...
        void Stop();
        void RegisterReadingCallback(pCallbackHandleReading pFn, void* pUser);
        void PushMsg(evutil_socket_t fd, const std::string& strData);
    ...
    public:
        ...
        void* m_pUser;
        pCallbackHandleReading m_cbReading;
