...
set(PROJECT_LINK_DIRECTORIES_DEBUG
    ...
    ${ENV_LIBEVENT}/win32/debug/lib
    ${ENV_FACE_SDK}/win32/debug/lib
)

set(PROJECT_LINK_DIRECTORIES_RELEASE
    ${PROJECT_LINK_DIRECTORIES}
    ${ENV_LIBEVENT}/win32/release/lib
    ${ENV_FACE_SDK}/win32/release/lib
)
...
set(DEBUGGER_ENVIRONMENT_DEBUG
    "PATH=$(Path)"
    ${ENV_LIBEVENT}/win32/debug/bin
    ${ENV_FACE_SDK}/win32/debug/bin
)

set(DEBUGGER_ENVIRONMENT_RELEASE
    "PATH=$(Path)"
    ${ENV_LIBEVENT}/win32/release/bin
    ${ENV_FACE_SDK}/win32/release/bin
)
