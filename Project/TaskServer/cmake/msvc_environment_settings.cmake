...
set(PROJECT_LINK_LIBRARIES_DEBUG
    ...
    opencv_imgproc${OPENCV_LIB_VER}d.lib
    avcodec.lib
    avformat.lib
    avutil.lib
    swscale.lib
...
set(PROJECT_LINK_LIBRARIES_RELEASE
    ...
    opencv_imgproc${OPENCV_LIB_VER}.lib
    avcodec.lib
    avformat.lib
    avutil.lib
    swscale.lib
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /wd4819 /wd4251 /wd4075")
