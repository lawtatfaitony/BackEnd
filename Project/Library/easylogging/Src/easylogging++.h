...
enum class ConfigurationType : base::type::EnumType {
  ...
  ///modified:20200114  support time format for rolling log file
...
class DateTime : base::StaticClass {
 public:
  ...
  // modified: 20200114     support for time-rolling file
...
class TypedConfigurations : public base::threading::ThreadSafe {
 public:
  ...
  // modified:20200116 support for day-rolling
  std::size_t dateTimeFormatForRollingLog(Level level);
 ...
 private:
  ...
  // modified:20200114  support for time-rolling file
  std::unordered_map<Level, std::string> m_logFileRollingTimeMap;
  std::unordered_map<Level, std::string> m_logFileFullNameMap;
  ...
  // modified:20200114    support time-rolling of file
  bool unsafeValidateFileRollingOnTime(Level level, const PreRollOutCallback& preRollOutCallback);
  bool CompareDateTimeForRollingLog(Level level, const std::string& fname);
  ...
  // modified:20200114    support time-rolling of file
  inline bool validateFileRollingOnTime(Level level, const PreRollOutCallback& preRollOutCallback) {
      base::threading::ScopedLock scopedLock(lock());
      return unsafeValidateFileRollingOnTime(level, preRollOutCallback);
  }
};
